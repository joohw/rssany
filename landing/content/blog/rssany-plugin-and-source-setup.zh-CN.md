---
title: RssAny 信源插件与 config.json 配置入门
description: 如何用内置 Site 插件、自定义 .rssany.js 与 config.json 的 sources 接入网页/RSS/邮件信源并设置刷新策略。
date: 2026-05-22
---
...
3. 在 `config.json` 的 sources 中引用插件名。
